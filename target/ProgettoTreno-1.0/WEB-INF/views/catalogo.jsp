				...
				<div class="card-body d-flex justify-content-between">
					...
					<div class="valuta-section">
						...
						<div id="valutaForm${treno.idTreno}"
							...
							<!-- Mostra l'errore se presente per questo treno -->
        ...
        <c:forEach var="treno" items="${treni}">
            <div class="card mb-3">
                <div class="card-body d-flex justify-content-between">
                    ...
                    <!-- Sezione pulsanti per "Vedi Dettagli" e "Valuta" -->
                    <div class="d-flex align-items-center">
                        <!-- Form per inviare l'ID del treno e visualizzare i dettagli -->
                        <form action="${pageContext.request.contextPath}/treni/visualizza/treno" method="post" class="mr-2">
                            <input type="hidden" name="idTreno" value="${treno.idTreno}" />
