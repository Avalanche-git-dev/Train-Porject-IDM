    ...
    <div class="profile-container">
        ...
        <div class="profile-section">
            ...
            <div class="edit-content" id="editContent">
                <form action="${pageContext.request.contextPath}/profilo/modifica" method="post">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="passwordVecchia" name="passwordVecchia" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="button-group">
                ...
                <button class="btn-action" onclick="window.location.href='${pageContext.request.contextPath}/treni/visualizza'">Vai a Treni</button>
