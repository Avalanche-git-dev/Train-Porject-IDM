...
<body>
    ...
    <div class="main">
        ...
        <div class="btn-container">
            ...
            <!-- Pulsante "Visualizza i tuoi treni" mappato alla pagina di visualizzazione treni -->
            <button class="cta-btn" onclick="window.location.href='${pageContext.request.contextPath}/visualizzaTreni'">Visualizza i tuoi treni</button>
            <!-- Pulsante "Collezioni" -->
            <button class="cta-btn" onclick="window.location.href='${pageContext.request.contextPath}/collezioni'">Collezioni</button>
        </div>
    </div>
