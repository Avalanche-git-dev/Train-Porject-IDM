...
<body>
    ...
    <div class="page-content-crea">
        ...
        <div class="train-grid-container">
            <div class="row">
                <c:forEach var="treno" items="${listaTreniUtente}" varStatus="status">
                    <div class="col-md-4 mb-0"data-index="${status.index}">
                        <div class="train-card-crea">
                            <h5>${treno.nome}</h5>
                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#optionsModal-${treno.idTreno}">Modifica</button>
                        </div>
                    </div>

                    <!-- Modal delle Opzioni -->
                    <div class="modal fade" id="optionsModal-${treno.idTreno}" tabindex="-1" aria-labelledby="optionsModalLabel-${treno.idTreno}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#aggiungiVagoneModal-${treno.idTreno}" data-bs-dismiss="modal">Aggiungi Vagone</button>
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#rimuoviVagoneModal-${treno.idTreno}" data-bs-dismiss="modal">Rimuovi Vagone</button>
                                    <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#copiaTrenoModal-${treno.idTreno}" data-bs-dismiss="modal">Copia Treno</button>
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#cancellaTrenoModal-${treno.idTreno}" data-bs-dismiss="modal">Cancella Treno</button>
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#invertiTrenoModal-${treno.idTreno}" data-bs-dismiss="modal">Inverti Treno</button>
                    ...
                    <div class="modal fade" id="aggiungiVagoneModal-${treno.idTreno}" tabindex="-1" aria-labelledby="aggiungiVagoneModalLabel-${treno.idTreno}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="aggiungiVagoneModalLabel-${treno.idTreno}">Aggiungi Vagone a ${treno.nome}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="${pageContext.request.contextPath}/treni/modifica/aggiungi" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="tipoVagone-${treno.idTreno}">Tipo di Vagone</label>
                                            <select class="form-control" id="tipoVagone-${treno.idTreno}" name="tipoVagone" required>
                    ...
                    <div class="modal fade" id="rimuoviVagoneModal-${treno.idTreno}" tabindex="-1" aria-labelledby="rimuoviVagoneModalLabel-${treno.idTreno}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="rimuoviVagoneModalLabel-${treno.idTreno}">Rimuovi Vagone da ${treno.nome}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="selezionaVagone-${treno.idTreno}" name="idVagone" required>
                                                <c:forEach var="vagone" items="${treno.vagoni}" varStatus="status">
                                                    <option value="${vagone.idVagone}">Posizione: ${status.index + 1} - ${vagoneTypeMap[vagone.idVagone]}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                    ...
                    <!-- Modal Copia Treno -->
                    <div class="modal fade" id="copiaTrenoModal-${treno.idTreno}" tabindex="-1" aria-labelledby="copiaTrenoModalLabel-${treno.idTreno}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="copiaTrenoModal Label-${treno.idTreno}">Copia Treno - ${treno.nome}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                    ...
                    <div class="modal fade" id="cancellaTrenoModal-${treno.idTreno}" tabindex="-1" aria-labelledby="cancellaTrenoModalLabel-${treno.idTreno}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="cancellaTrenoModalLabel-${treno.idTreno}">Cancella Treno - ${treno.nome}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                    ...
                    <!-- Modal Inverti Treno -->
                    <div class="modal fade" id="invertiTrenoModal-${treno.idTreno}" tabindex="-1" aria-labelledby="invertiTrenoModalLabel-${treno.idTreno}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="invertiTrenoModalLabel-${treno.idTreno}">Inverti Treno - ${treno.nome}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="${pageContext.request.contextPath}/treni/modifica/inverti" method="post">
                                        <input type="hidden" name="idTrenoM" value="${treno.idTreno}">
                                        <p>Sei sicuro di voler invertire la disposizione dei vagoni per il treno <strong>${treno.nome}</strong>?</p>
