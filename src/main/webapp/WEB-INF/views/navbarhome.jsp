...
<nav class="navbar navbar-expand-lg navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <form class="form-inline" action="${pageContext.request.contextPath}/login" method="post">
            <button class="btn logout-btn my-2 my-sm-0" type="submit">Login</button>
            <i class="fas fa-cog settings-icon" title="Impostazioni"></i>
        </form>
        <form class="form-inline" action="${pageContext.request.contextPath}/registrazione" method="post">
            <button class="btn logout-btn my-2 my-sm-0" type="submit">Registrati</button>
            <i class="fas fa-cog settings-icon" title="Impostazioni"></i>
        </form>
    </div>
</nav>
