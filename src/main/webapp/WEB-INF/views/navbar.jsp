...
<nav class="navbar navbar-expand-lg navbar-primary bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <form class="form-inline" action="${pageContext.request.contextPath}/user/logout" method="post">
            <button class="btn btn-secondary logout-btn my-2 my-sm-0" type="submit">Logout</button>
            <i class="fas fa-cog settings-icon" title="Impostazioni"></i>
        </form>
    </div>
</nav>
...
<style>
    .navbar-primary {
        background-color: #0275d8; /* Blu primario */
        padding: 15px;
    }
    ...
    .navbar-brand:hover {
        color: #f8f9fa; /* Grigio chiaro per hover */
        background-color: #025aa5; /* Blu scuro per hover */
    }

    .navbar-nav .nav-item .nav-link {
        color: white; /* Bianco per i link */
        margin-right: 20px;
        font-size: 18px;
        transition: color 0.3s ease, background-color 0.3s ease;
    }
    ...
    .logout-btn {
        background-color: #444; /* Grigio scuro per logout */
        color: white;
        padding: 10px 20px;
        border: none;
        border-radius: 20px;
